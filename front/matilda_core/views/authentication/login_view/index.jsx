...
export default (props) => <MatildaContainer matilda={props.matilda} layout="authentication"><LoginView {...props} /></MatildaContainer>

/********************************************************************************************** */

function LoginView() {
  const { config: { authentication_session_valid_custom_redirect, authentication_permit_signup } } = useContext(MatildaContext)
